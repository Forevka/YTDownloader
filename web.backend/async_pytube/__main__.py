...
from async_pytube import Caption
from async_pytube import CaptionQuery
from async_pytube import extract
from async_pytube import mixins
from async_pytube import request
from async_pytube import Stream
from async_pytube import StreamQuery
from async_pytube.compat import install_proxy
from async_pytube.compat import parse_qsl
from async_pytube.exceptions import VideoUnavailable
from async_pytube.helpers import apply_mixin
...
class YouTube(object):
    ...
    async def prefetch(self):
        ...
        self.vid_info = await request.get(self.vid_info_url)
